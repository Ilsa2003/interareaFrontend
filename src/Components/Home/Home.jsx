...
function Home() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://internareaback.onrender.com/api/internship`)
    ...
    return (
        <>
            <h1 className='text-center text-3xl font-bold'>Make Your Drean Career A Reality</h1>
            ...
            <div className="infoys">
                <div className="info-intern">
                    ...
                    <div className="categories flex flex-wrap mt-14 mr-17">
                        <p className='pplr'>POPULAR CATEGORIES :</p>
            ...
            <div className="logins flex  h-32 mt-8">
                <div className="cont">
                    <p className="flex justify-center text-white text-xl items-center m-5 w-30">Empower Your Career Eith InternArea Today</p>
                </div>
