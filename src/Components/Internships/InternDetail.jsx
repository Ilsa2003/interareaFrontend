...
function InternDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`https://internareaback.onrender.com/api/internship/${id}`)
        ...
        <>
          ...
          <div className="m-14 shadow-sm rounded-md border">
            ...
            <div className="flex tedxt-sm justify-between">
              ...
              <p className='mt-3 text-slate-600' > <i class="bi bi-calendar-check-fill"></i>  Duration  <br />
                {data.Duration}</p>

              <p className='mt-3 text-slate-600'>  <i class="bi bi-cash"></i>   stipend <br /> {data.stipend}</p>
            </div>
            <div className="flex">
